...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Panel'); ?> — Food-TYU</title>
...
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <div class="sidebar-brand">
        <a href="/admin/dashboard" class="flex items-center gap-3">
            <div class="w-9 h-9 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0">
                <img src="<?php echo e(asset('images/logo-foodtyu.png')); ?>" alt="Logo" class="w-6 h-6 object-contain">
            </div>
            <div>
    ...
    <div class="px-4 py-3">
        <div class="admin-info-card">
            <div class="flex items-center gap-2.5">
                ...
                <div class="min-w-0">
                    <p class="text-white text-xs font-black truncate"><?php echo e(Auth::user()->name); ?></p>
    ...
    <div class="flex-1 overflow-y-auto pb-2">
        ...
        <a href="/admin/dashboard"
           class="admin-nav-item <?php echo e(request()->is('admin/dashboard') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-chart-line"></i></span>
            Dashboard
        </a>

        <a href="/admin/orders"
           class="admin-nav-item <?php echo e(request()->is('admin/orders*') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-receipt"></i></span>
            Monitoring Pesanan
            <?php $pendingCount = \App\Models\Order::where('status','pending')->count(); ?>
            <?php if($pendingCount > 0): ?>
            <span class="ml-auto bg-red-500 text-white text-[9px] font-black px-1.5 py-0.5 rounded-full min-w-[18px] text-center animate-pulse"><?php echo e($pendingCount); ?></span>
            <?php endif; ?>
        </a>
        ...
        <a href="/admin/canteens"
           class="admin-nav-item <?php echo e(request()->is('admin/canteens*') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-store"></i></span>
            Kelola Kantin
        </a>

        <a href="/admin/users"
           class="admin-nav-item <?php echo e(request()->is('admin/users*') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-users"></i></span>
            Users Management
        </a>

        <a href="/admin/vouchers"
           class="admin-nav-item <?php echo e(request()->is('admin/vouchers*') ? 'active' : ''); ?>">
        ...
        <a href="/admin/export"
           class="admin-nav-item <?php echo e(request()->is('admin/export*') ? 'active' : ''); ?>">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <div class="flex items-center gap-2 text-xs text-slate-400 font-bold mb-0.5">
                    ...
                    <span class="text-[#0B2D5C]"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></span>
                </div>
                <h1 class="text-lg font-black text-[#0B2D5C] leading-none"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
            </div>
        </div>
...
<?php /**PATH D:\PROJECT WEB\WEB KANTIN\hulahup-localhost\resources\views/layouts/admin.blade.php ENDPATH**/ ?>