    ...
    <div class="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <a href="/" class="flex items-center gap-2.5 group">
            <div class="w-9 h-9 bg-white/15 rounded-xl flex items-center justify-center group-hover:bg-white/25 transition">
                <img src="<?php echo e(asset('images/logo-foodtyu.png')); ?>" alt="Food-TYU" class="w-6 h-6 object-contain">
            </div>
                    ...
                    <div class="phone-frame">
                        ...
                        <div class="phone-screen">
                            ...
                            <div class="flex items-center gap-2 mb-3">
                                <img src="<?php echo e(asset('images/logo-foodtyu.png')); ?>" class="w-6 h-6 object-contain">
                            ...
                            <div class="space-y-2">
                                ...
                                ?>
                                <?php $__currentLoopData = $demoMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-2 bg-white rounded-xl p-2 shadow-sm">
                                    <span class="text-xl"><?php echo e($dm['emoji']); ?></span>
                                    <div class="flex-1 min-w-0">
                                        <p class="font-bold text-[var(--navy)] text-[9px] truncate"><?php echo e($dm['name']); ?></p>
                                        <p class="text-green-600 font-black text-[9px]"><?php echo e($dm['price']); ?></p>
                                    </div>
                                    <span class="text-[8px] bg-[var(--pink)]/20 text-pink-600 px-1.5 py-0.5 rounded-full font-bold whitespace-nowrap"><?php echo e($dm['tag']); ?></span>
                                </div>
...
<section class="py-4 bg-[var(--cream)] overflow-hidden">
    <div class="flex whitespace-nowrap marquee-l gap-0">
        <?php $__currentLoopData = range(1,3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<section class="py-20 px-6" id="canteens" style="background: linear-gradient(180deg, var(--cream) 0%, #EEF4FF 100%)">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8 reveal">
            ...
            ?>
            <?php $__currentLoopData = $demoCanteens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $dc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card-hover bg-white rounded-3xl overflow-hidden border border-[var(--navy)]/5 shadow-sm" style="transition-delay:<?php echo e($i*0.1); ?>s">
                <div class="h-48 bg-gradient-to-br <?php echo e($dc['color']); ?> relative flex items-center justify-center">
                    <span class="text-7xl opacity-90"><?php echo e($dc['emoji']); ?></span>
                    <div class="absolute top-4 right-4">
                        <span class="text-xs font-black px-3 py-1.5 rounded-full <?php echo e($dc['open'] ? 'bg-green-400/20 text-green-100 border border-green-400/30' : 'bg-red-400/20 text-red-100 border border-red-400/30'); ?>">
                            <?php echo e($dc['open'] ? '● Buka' : '● Tutup'); ?>

                        </span>
                    </div>
                    <div class="absolute top-4 left-4 glass rounded-xl px-2.5 py-1.5 flex items-center gap-1.5">
                        <i class="fas fa-star text-yellow-400 text-xs"></i>
                        <span class="text-white font-black text-xs"><?php echo e($dc['rating']); ?></span>
                    </div>
                </div>
                <div class="p-6">
                    <h3 class="font-black text-[var(--navy)] text-lg mb-2"><?php echo e($dc['name']); ?></h3>
                    <p class="text-slate-500 text-sm font-medium leading-relaxed mb-4"><?php echo e($dc['desc']); ?></p>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-slate-400 font-bold"><i class="fas fa-utensils mr-1.5"></i><?php echo e($dc['menu']); ?> menu tersedia</span>
        ...
        <div class="grid md:grid-cols-<?php echo e(min(3, $canteensData->count())); ?> gap-8 reveal">
            ...
            <div class="card-hover bg-white rounded-3xl overflow-hidden border border-[var(--navy)]/5 shadow-sm" style="transition-delay:<?php echo e($i*0.1); ?>s">
                ...
                <div class="p-6">
                    <h3 class="font-black text-[var(--navy)] text-lg mb-2"><?php echo e($canteen->name); ?></h3>
                    <p class="text-slate-500 text-sm font-medium leading-relaxed mb-4"><?php echo e($canteen->description ?? 'Kantin terpercaya dengan menu lezat dan pelayanan cepat.'); ?></p>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-slate-400 font-bold"><i class="fas fa-utensils mr-1.5"></i><?php echo e($menuCount); ?> menu tersedia</span>
                        <a href="/login" class="bg-[var(--navy)] text-white text-xs font-black px-4 py-2 rounded-xl hover:bg-[var(--blue)] transition">
                            Lihat Menu →
                        </a>
                    </div>
...
<section class="py-20 px-6 bg-[var(--cream)]" id="menus">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 reveal">
            ...
            ?>
            <?php $__currentLoopData = $demoMenuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $dm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card-hover bg-white rounded-2xl p-4 text-center border border-[var(--navy)]/5 shadow-sm" style="transition-delay:<?php echo e($i*0.08); ?>s">
                <div class="text-5xl mb-3"><?php echo e($dm['emoji']); ?></div>
                <p class="font-black text-[var(--navy)] text-sm mb-1 line-clamp-2"><?php echo e($dm['name']); ?></p>
                <p class="text-green-600 font-black text-sm mb-2"><?php echo e($dm['price']); ?></p>
                <div class="flex items-center justify-center gap-1 mb-2">
                    <i class="fas fa-star text-yellow-400 text-xs"></i>
                    <span class="text-xs font-bold text-slate-600"><?php echo e($dm['rating']); ?></span>
                </div>
                <span class="text-[9px] bg-red-50 text-red-500 border border-red-100 font-black px-2 py-0.5 rounded-full">🔥 <?php echo e($dm['sold']); ?>x terjual</span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php else: ?>
...
<section class="py-24 px-6 bg-[var(--cream)]">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8 reveal">
            ...
            <div class="relative" style="transition-delay:<?php echo e($i*0.15); ?>s">
                <?php if($i < 2): ?>
                ...
                <div class="bg-white rounded-3xl p-8 text-center border border-[var(--navy)]/5 shadow-sm card-hover relative z-10">
                    <div class="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-5 shadow-lg" style="background: linear-gradient(135deg, <?php echo e($step['color']); ?>, <?php echo e($step['color']); ?>88)">
                        <?php echo e($step['emoji']); ?>

                    </div>
                    <span class="text-xs font-black text-[var(--navy)]/30 uppercase tracking-widest">Langkah <?php echo e($step['no']); ?></span>
                    <h3 class="text-[var(--navy)] font-black text-xl mt-2 mb-3"><?php echo e($step['title']); ?></h3>
                    <p class="text-slate-500 text-sm font-medium leading-relaxed"><?php echo e($step['desc']); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<section class="py-24 px-6" id="testimonials" style="background: linear-gradient(180deg, var(--cream) 0%, #EEF4FF 100%)">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-6 reveal">
            ...
            ?>
            <?php $__currentLoopData = $testis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="testi-card" style="transition-delay:<?php echo e($i*0.08); ?>s">
                <!-- Stars -->
                ...
                <!-- Quote -->
                <p class="text-slate-600 text-sm font-medium leading-relaxed mb-6">"<?php echo e($t['text']); ?>"</p>
                <!-- User -->
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center text-white font-black text-sm" style="background: <?php echo e($t['color']); ?>">
                        <?php echo e($t['avatar']); ?>

                    </div>
                    <div>
                        <p class="font-black text-[var(--navy)] text-sm"><?php echo e($t['name']); ?></p>
                        <p class="text-slate-400 text-xs font-medium"><?php echo e($t['nim']); ?></p>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mt-14 bg-[var(--navy)] rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 reveal">
            ...
            <div class="flex-1 space-y-3">
                <?php $__currentLoopData = [['pct'=>85,'stars'=>5],['pct'=>10,'stars'=>4],['pct'=>4,'stars'=>3],['pct'=>1,'stars'=>2]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center gap-3">
                    <span class="text-white/60 text-xs font-bold w-4"><?php echo e($r['stars']); ?></span>
                    <i class="fas fa-star text-yellow-400 text-xs"></i>
                    <div class="flex-1 bg-white/10 rounded-full h-2">
                        <div class="bg-yellow-400 h-2 rounded-full transition-all" style="width:<?php echo e($r['pct']); ?>%"></div>
                    </div>
                    <span class="text-white/60 text-xs font-bold w-8"><?php echo e($r['pct']); ?>%</span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="text-center">
            ...
            <div class="reveal">
                ...
                <div class="space-y-4 mb-8">
                    ...
                    <div class="flex gap-4 p-4 bg-white rounded-2xl border border-[var(--navy)]/5 shadow-sm">
                        <div class="w-10 h-10 rounded-xl flex-shrink-0 flex items-center justify-center" style="background: <?php echo e($info['color']); ?>15">
                            <i class="fas <?php echo e($info['icon']); ?> text-sm" style="color: <?php echo e($info['color']); ?>"></i>
                        </div>
                        <div>
                            <p class="text-xs font-black text-slate-400 uppercase tracking-widest mb-0.5"><?php echo e($info['label']); ?></p>
                            <p class="font-semibold text-[var(--navy)] text-sm"><?php echo e($info['val']); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="reveal">
                <div class="rounded-3xl overflow-hidden shadow-2xl border-4 border-white relative">
                    ...
                    <div class="absolute top-4 left-4 bg-white rounded-xl px-4 py-3 shadow-lg flex items-center gap-3">
                        <img src="<?php echo e(asset('images/logo-foodtyu.png')); ?>" class="w-8 h-8 object-contain">
                        <div>
    ...
    <div class="max-w-5xl mx-auto text-center reveal">
        ...
        <div class="flex flex-wrap justify-center items-center gap-4">
            ...
            <div class="glass rounded-2xl px-5 py-3 flex items-center gap-2.5">
                <i class="fas <?php echo e($p['icon']); ?> text-[var(--soft-blue)]"></i>
                <div class="text-left">
                    <p class="text-white font-black text-sm"><?php echo e($p['label']); ?></p>
                    <p class="text-white/40 text-[10px] font-bold"><?php echo e($p['desc']); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
            ...
            <div class="relative z-10">
                <div class="flex justify-center mb-6">
                    <div class="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-3xl flex items-center justify-center border border-white/30 float-slow shadow-xl">
                        <img src="<?php echo e(asset('images/logo-foodtyu.png')); ?>" alt="Food-TYU" class="w-12 h-12 object-contain">
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-6 py-16">
        <div class="grid md:grid-cols-4 gap-10 mb-12">
            ...
            <div class="md:col-span-2">
                <div class="flex items-center gap-3 mb-5">
                    <div class="w-11 h-11 bg-white/10 rounded-xl flex items-center justify-center">
                        <img src="<?php echo e(asset('images/logo-foodtyu.png')); ?>" alt="Food-TYU" class="w-7 h-7 object-contain">
                    </div>
                ...
                <div class="flex gap-3">
                    <?php $__currentLoopData = [['icon'=>'fa-instagram','href'=>'#'],['icon'=>'fa-twitter','href'=>'#'],['icon'=>'fa-tiktok','href'=>'#'],['icon'=>'fa-envelope','href'=>'mailto:foodtyu@telkomuniversity.ac.id']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($social['href']); ?>" class="w-10 h-10 bg-white/10 hover:bg-[var(--pink)] rounded-xl flex items-center justify-center text-white/60 hover:text-white transition-all">
                        <i class="fab <?php echo e($social['icon']); ?> text-sm"></i>
                    </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = ['Beranda'=>'#hero','Fitur'=>'#features','Kantin'=>'#canteens','Menu'=>'#menus','Testimoni'=>'#testimonials']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $href): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($href); ?>" class="block text-white/50 hover:text-[var(--pink)] text-sm font-medium transition"><?php echo e($label); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        ...
        <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p class="text-white/30 text-xs font-medium">© <?php echo e(date('Y')); ?> Food-TYU. Platform Kantin Digital Telkom University Purwokerto.</p>
            <div class="flex items-center gap-2">
